...
export const forgotPasswordRequestSchema = z.object({ email: emailSchema }).strict().meta({
...
export const verifyPasswordResetOtpRequestSchema = z.object({ email: emailSchema, otp: otpSchema }).strict().meta({
