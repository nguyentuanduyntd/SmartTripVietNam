...
const storyStatusSchema = z.enum(["all", "pending", "approved", "hidden"]);

export const adminStoryListQuerySchema = z.object({
  query: z.string().trim().max(120).default(""),
  status: storyStatusSchema.default("all"),
  locationId: z.union([z.uuid(), z.literal("")]).default(""),
...
export type DeleteAdminStoryInput = z.infer<typeof deleteAdminStorySchema>;
