...
export const userItinerariesRelations = relations(userItineraries, ({ one, many }) => ({
  user: one(profiles, {
...
export const itineraryMealsRelations = relations(itineraryMeals, ({ one, many }) => ({
  day: one(itineraryDays, {
...
export const itineraryMealCuisinesRelations = relations(itineraryMealCuisines, ({ one }) => ({
  meal: one(itineraryMeals, {
    fields: [itineraryMealCuisines.itineraryMealId],
...
export const itineraryCostsRelations = relations(itineraryCosts, ({ one }) => ({
  itinerary: one(userItineraries, {
