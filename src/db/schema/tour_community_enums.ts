...
export const communityReportReasonEnum = pgEnum("community_report_reason", COMMUNITY_REPORT_REASONS);

export const communityReportStatusEnum = pgEnum("community_report_status", COMMUNITY_REPORT_STATUSES);
