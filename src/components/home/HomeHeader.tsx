        ...
        <header className="fixed inset-x-0 top-0 z-50 px-4 pt-4 sm:px-6 lg:px-8 lg:pt-6">
            ...
            {isOpen ? (
                ...
                >
                    ...
                    <div className="mt-3 grid gap-3 border-t border-[#ded5c6] pt-4 sm:grid-cols-2">
                        <Link
                            href="/auth/login"
                            onClick={closeMenu}
                        ...
                        <Link
                            href="/planner"
                            onClick={closeMenu}
                            className="flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#173a3b] px-4 py-3 text-center text-sm font-semibold text-white transition-colors hover:bg-[#20494a]"
                        >
                            <Route size={17} />
                            Lập hành trình
                        </Link>
