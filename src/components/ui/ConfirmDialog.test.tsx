...
describe("ConfirmDialog", () => {
  ...
  it("hiển thị tiêu đề, mô tả và nhãn mặc định", () => {
    ...
    expect(screen.getByText("Story sẽ bị xóa vĩnh viễn.")).toBeInTheDocument();
    expect(
  ...
  it("hỗ trợ nhãn tùy chỉnh và chế độ không nguy hiểm", () => {
    render(<ConfirmDialog {...defaultProps} danger={false} confirmLabel="Đồng ý" cancelLabel="Quay lại" />);
