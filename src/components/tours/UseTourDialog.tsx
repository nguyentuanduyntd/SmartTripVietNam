    ...
    return (
        <>
            <button
                type="button"
                onClick={openDialog}
                className="inline-flex min-h-[52px] w-full items-center justify-center gap-2 rounded-full bg-[#173a3b] px-5 py-3.5 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-[#20494a]"
            >
                <Route size={18} />
                Dùng hành trình này
            </button>
            ...
            {isOpen ? (
                <div
                    className="fixed inset-0 z-[100] flex items-end justify-center bg-[#102f30]/60 p-0 backdrop-blur-sm sm:items-center sm:p-5"
                    role="presentation"
                    onMouseDown={(event) => {
                        if (
                            event.target ===
                ...
                >
                    <section
                        ...
                        className="max-h-[92dvh] w-full overflow-y-auto rounded-t-[30px] border border-white/70 bg-[#fffaf1] shadow-[0_30px_100px_rgba(10,35,36,0.3)] sm:max-w-2xl sm:rounded-[30px]"
                    >
                        <header className="sticky top-0 z-10 flex items-start justify-between gap-5 border-b border-[#e2d8c9] bg-[#fffaf1]/95 px-5 py-5 backdrop-blur sm:px-7">
                            <div>
                            ...
                            <button
                                ...
                                className="grid h-10 w-10 shrink-0 place-items-center rounded-full border border-[#ddd2c2] bg-white text-[#60706d] transition hover:bg-[#f3eadc] hover:text-[#173a3b] disabled:cursor-not-allowed disabled:opacity-50"
                        ...
                        >
                            ...
                            <div className="mt-7 rounded-2xl border border-[#d9e5df] bg-[#edf5f1] px-4 py-3 text-sm leading-6 text-[#54706c]">
                                Chi phí tour hiện tại sẽ
                                được sao chép thành khoản
                                tham khảo theo đầu người.
                                Bạn có thể chia nhỏ thành vé,
                                ăn uống, di chuyển và khách
                                sạn trong trang chỉnh sửa.
                            </div>
                            ...
                            <footer className="mt-7 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                                <button
                                    ...
                                    className="inline-flex h-13 items-center justify-center rounded-full border border-[#d8cdbc] bg-white px-6 text-sm font-bold text-[#294748] transition hover:bg-[#f3eadc] disabled:cursor-not-allowed disabled:opacity-50"
                                >
                                    Hủy
                                </button>
                                ...
                                <button
                                    ...
                                    className="inline-flex h-13 items-center justify-center gap-2 rounded-full bg-[#173a3b] px-7 text-sm font-bold text-white shadow-[0_14px_34px_rgba(23,58,59,0.2)] transition hover:-translate-y-0.5 hover:bg-[#21494a] disabled:cursor-not-allowed disabled:translate-y-0 disabled:opacity-60"
                                >
                                    {isSubmitting ? (
                                        <>
                                            <LoaderCircle
