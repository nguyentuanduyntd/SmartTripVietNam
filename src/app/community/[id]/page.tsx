...
export const metadata: Metadata = {
  ...
  description: "Xem bài chia sẻ trải nghiệm du lịch trong cộng đồng SmartTripVietNam.",
};
    ...
    <>
      ...
      <main className="min-h-screen bg-[#f4efe6] px-4 pb-20 pt-28 text-[#173a3b] sm:px-6 sm:pt-32 lg:px-8 lg:pt-36">
        <div className="mx-auto w-full max-w-6xl">
          ...
          <CommunityPostDetail postId={resolvedParams.id} currentUserId={currentUser?.id ?? null} />
        </div>
      </main>
    </>
  );
