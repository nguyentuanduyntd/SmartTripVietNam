    ...
    <main className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-[#f7efe1] px-5 py-10 text-[#173a3b]">
      ...
      <div className="relative w-full max-w-[520px]">
        ...
        <div className="rounded-[34px] border border-white/80 bg-[#fffaf1]/95 p-7 shadow-[0_28px_90px_rgba(30,56,52,0.13)] backdrop-blur sm:p-10">
          {step === "request" ? (
            <>
              <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-[#e55c49]">Khôi phục tài khoản</p>
              <h1 className="mt-3 font-display text-4xl font-semibold tracking-[-0.035em] sm:text-5xl">
                Quên mật khẩu?
              </h1>
              <p className="mt-4 leading-7 text-[#687572]">
                Nhập email đã đăng ký. SmartTrip sẽ gửi cho bạn một mã OTP gồm 6 chữ số để đặt lại mật khẩu.
              </p>
          ...
          {step === "verify" ? (
            <>
              <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-[#e55c49]">Xác thực OTP</p>
              <h1 className="mt-3 font-display text-4xl font-semibold tracking-[-0.035em] sm:text-5xl">Nhập mã OTP</h1>
              <p className="mt-4 leading-7 text-[#687572]">
                SmartTrip đã gửi mã OTP tới <span className="font-extrabold text-[#173a3b]">{email}</span>. Mã có hiệu
                lực trong 10 phút.
              </p>
          ...
          {step === "password" ? (
            <>
              <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-[#e55c49]">Tạo mật khẩu mới</p>
              <h1 className="mt-3 font-display text-4xl font-semibold tracking-[-0.035em] sm:text-5xl">
                Đặt mật khẩu mới
              </h1>
              ...
              <div className="mt-5 flex items-start gap-3 rounded-2xl border border-[#cce2d8] bg-[#edf7f2] px-4 py-3 text-sm leading-6 text-[#337363]">
                ...
                <p>
                  Mã OTP đã được xác thực cho <span className="font-extrabold">{email}</span>.
                </p>
              </div>
