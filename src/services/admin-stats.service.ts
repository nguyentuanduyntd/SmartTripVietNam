...
function fillTimeline(month: string, rows: Array<{ day: string; value: number }>) {
  const { year, month: monthNumber } = getMonthParts(month);
  ...
  return {
    ...
    monthly: {
      destinations: {
        ...
        changePercent: percentChange(data.monthly.destinations.current, data.monthly.destinations.previous),
      },
      cuisines: {
        ...data.monthly.cuisines,
        changePercent: percentChange(data.monthly.cuisines.current, data.monthly.cuisines.previous),
      },
      stories: {
        ...data.monthly.stories,
        changePercent: percentChange(data.monthly.stories.current, data.monthly.stories.previous),
      },
      users: {
        ...data.monthly.users,
        changePercent: percentChange(data.monthly.users.current, data.monthly.users.previous),
      },
      activeAuthors: {
        ...data.monthly.activeAuthors,
        changePercent: percentChange(data.monthly.activeAuthors.current, data.monthly.activeAuthors.previous),
      },
    },
    timelines: {
