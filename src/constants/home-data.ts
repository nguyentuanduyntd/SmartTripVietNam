...
import { Compass, Landmark, Map, Mountain, Palmtree, Sparkles, Sun, Waves } from "lucide-react";
...
export const HOME_MEDIA = {
  ...
  heroDaNang:
    "https://res.cloudinary.com/dgwehj5d0/image/upload/v1784618994/pexels-quang-nguyen-vinh-222549-2162471_sfohas.jpg",
  ...
  imperialCity: "smart-trip-vietnam/home/destinations/imperial-city-hue",
  thienMu: "smart-trip-vietnam/home/destinations/thien-mu-pagoda",
  myKhe: "smart-trip-vietnam/home/destinations/my-khe-beach",
  dragonBridge: "smart-trip-vietnam/home/destinations/dragon-bridge",
  hoiAnAncientTown: "smart-trip-vietnam/home/destinations/hoi-an-ancient-town",
  chamIsland: "smart-trip-vietnam/home/destinations/cham-island",

  bunBoHue: "smart-trip-vietnam/home/cuisines/bun-bo-hue",
  miQuang: "smart-trip-vietnam/home/cuisines/mi-quang",
  caoLau: "smart-trip-vietnam/home/cuisines/cao-lau",
  comGaHoiAn: "smart-trip-vietnam/home/cuisines/com-ga-hoi-an",

  journeyHeritage: "smart-trip-vietnam/home/journeys/heritage",
  journeyCoast: "smart-trip-vietnam/home/journeys/coast",
  journeyThreeCities: "smart-trip-vietnam/home/journeys/three-cities",

  storyLantern: "smart-trip-vietnam/home/stories/lantern-night",
  storyHue: "smart-trip-vietnam/home/stories/hue-morning",
  storyBeach: "smart-trip-vietnam/home/stories/da-nang-beach",
} as const;
...
export const HOME_CITIES: HomeCity[] = [
  {
    ...
    headline: "Chạm vào nhịp sống chậm bên dòng Hương Giang",
    description:
    ...
    imageAlt: "Khung cảnh Huế bên sông Hương vào lúc bình minh",
    accent: "#ed6a5a",
    softAccent: "#fbe3dc",
    icon: Landmark,
  ...
  },
  {
    ...
    headline: "Đón nắng mới giữa biển xanh và nhịp phố hiện đại",
    description:
    ...
    imageAlt: "Đà Nẵng nhìn từ sông Hàn trong ánh nắng sớm",
    accent: "#2f8f8b",
    softAccent: "#dcefeb",
    icon: Waves,
  ...
  },
  {
    ...
    headline: "Lạc bước trong phố đèn lồng và những câu chuyện cũ",
    description:
    ...
    imageAlt: "Phố cổ Hội An rực sáng bên sông Hoài",
    accent: "#d8a52f",
    softAccent: "#f8edcc",
    icon: Sun,
...
export const CITY_EDITORIAL = [
  {
    ...
    title: "Một miền ký ức được kể bằng kiến trúc, âm nhạc và vị cay nồng.",
  ...
  },
  {
    ...
    title: "Từ bình minh Mỹ Khê đến ánh đèn bên bờ sông Hàn.",
  ...
  },
  {
    ...
    title: "Chậm lại giữa những mái nhà vàng và bàn tay của người thợ thủ công.",
...
export const FEATURED_DESTINATIONS: DestinationCardData[] = [
  {
    ...
    description: "Quần thể cung điện cổ của triều Nguyễn giữa lòng cố đô.",
  ...
  },
  {
    ...
    cityLabel: "Huế",
    category: "Tâm linh",
    description: "Biểu tượng bên bờ sông Hương với tháp Phước Duyên bảy tầng.",
  ...
  },
  {
    ...
    cityLabel: "Đà Nẵng",
    category: "Biển",
    description: "Dải cát trắng dài, nước êm và bình minh trong trẻo.",
  ...
  },
  {
    ...
    description: "Cây cầu rực sáng bên sông Hàn với màn phun lửa cuối tuần.",
  ...
  },
  {
    ...
    description: "Những căn nhà vàng và phố đèn lồng bên sông Hoài.",
  ...
  },
  {
    ...
    description: "Cụm đảo xanh với bãi biển và hệ sinh thái san hô đa dạng.",
...
export const CUISINES: CuisineCardData[] = [
  {
    ...
    city: "Huế",
    price: "Từ 35.000đ",
    description: "Nước dùng thơm sả, vị mắm ruốc và chút cay đặc trưng xứ Huế.",
  ...
  },
  {
    ...
    price: "Từ 30.000đ",
    description: "Sợi mì vàng, nước dùng đậm, rau sống và bánh tráng nướng giòn.",
  ...
  },
  {
    ...
    city: "Hội An",
    price: "Từ 35.000đ",
    description: "Sợi mì dai, thịt xá xíu và rau Trà Quế trong một hương vị rất riêng.",
  ...
  },
  {
    ...
    city: "Hội An",
    price: "Từ 35.000đ",
    description: "Cơm vàng thơm, gà xé, rau răm và nước sốt đậm đà.",
...
export const JOURNEYS: JourneyCardData[] = [
  {
    ...
    description: "Đi qua di sản, thưởng trà bên sông và kết thúc bằng bữa tối đậm vị cố đô.",
    startLocation: "Huế",
    price: "Liên hệ",
  ...
  },
  {
    ...
    description: "Kết hợp biển Mỹ Khê, bán đảo Sơn Trà và một đêm ngắm sông Hàn lên đèn.",
  ...
  },
  {
    ...
    description: "Hành trình trọn vẹn nối Huế, Đà Nẵng và Hội An theo nhịp đi vừa đủ chậm.",
    startLocation: "Huế",
    price: "Liên hệ",
    image: HOME_MEDIA.journeyThreeCities,
    imageAlt: "Hành trình xuyên Huế Đà Nẵng Hội An",
    tone: "gold",
    href: "/planner",
  },
];
